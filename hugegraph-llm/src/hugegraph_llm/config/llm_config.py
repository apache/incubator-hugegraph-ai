...
class LLMConfig(BaseConfig):
    ...
    chat_llm_type: Literal["openai", "ollama/local", "qianfan_wenxin", "zhipu", "litellm"] = "openai"
    extract_llm_type: Literal["openai", "ollama/local", "qianfan_wenxin", "zhipu", "litellm"] = "openai"
    text2gql_llm_type: Literal["openai", "ollama/local", "qianfan_wenxin", "zhipu", "litellm"] = "openai"
    embedding_type: Optional[Literal["openai", "ollama/local", "qianfan_wenxin", "zhipu", "litellm"]] = "openai"
