...
class VectorIndexQuery:
    def __init__(self, embedding: BaseEmbedding, topk: int = 10):
        ...
        self.topk = topk
        index_file = str(os.path.join(resource_path, settings.graph_name, "index.faiss"))
        content_file = str(os.path.join(resource_path, settings.graph_name, "properties.pkl"))
