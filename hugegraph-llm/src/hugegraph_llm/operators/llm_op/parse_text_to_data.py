...
def generate_system_message_wenxin() -> str:
    ...
    and Bob owns the webpage www.bob.com.
"""


def generate_system_message_wenxin_assistant() -> str:
    return """The output you need to provide: Nodes: ["Alice", "Person", {"age": 25,
...
Here is an example The input you will be given: Data: Alice lawyer and is 25 years old and Bob is 
her roommate since 2001. Bob works as a journalist. Alice owns a the webpage www.alice.com and 
Bob owns the webpage www.bob.com. NodesSchemas: ["Person", "name",  {"age": "int", 
...
{"Webpage": "alice.com"}, {}], [{"Person": "Bob"}, "owns", {"Webpage": "bob.com"}, 
{}] NodesSchemas: ["Person", "name",  {"age": "int", "name": "text", "occupation": "text"}],  
["Webpage", "name", {"name": "text", "url": "text"}] RelationshipsSchemas :["Person", "roommate", 
"Person", {"start": "int"}], ["Person", "owns", "Webpage", {}]"""
    ...
    def process(self, chunk):
        if self.llm.get_llm_type() == "openai":
            ...
            messages = [
                ...
                {
                    "role": "assistant",
                    "content": generate_system_message_wenxin_assistant(),
                },
                {"role": "user", "content": generate_prompt(chunk)},
            ]
