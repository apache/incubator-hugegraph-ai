...
class TestChunkSplitter(unittest.TestCase):
    def test_paragraph_split_zh(self):
        ...
        self.assertTrue(any("这是第一段" in chunk for chunk in chunks) or 
                       any("这是第二段" in chunk for chunk in chunks))
    ...
    def test_sentence_split_zh(self):
        ...
        self.assertTrue(any("这是第一句话" in chunk for chunk in chunks) or 
                       any("这是第二句话" in chunk for chunk in chunks) or
                       any("这是第三句话" in chunk for chunk in chunks))
    ...
    def test_paragraph_split_en(self):
        ...
        # The actual behavior may vary based on the implementation
        # Just verify we get some chunks
        self.assertTrue(any("first paragraph" in chunk for chunk in chunks) or 
                       any("second paragraph" in chunk for chunk in chunks))
    ...
    def test_sentence_split_en(self):
        ...
        for chunk in chunks:
            self.assertTrue("first sentence" in chunk or 
                           "second sentence" in chunk or
                           "third sentence" in chunk or
                           chunk.startswith("This is"))
    ...
    def test_multiple_documents(self):
        ...
        self.assertTrue(any("document one" in chunk for chunk in chunks) or 
                       any("document two" in chunk for chunk in chunks))
