...
class TestGraphRAGQuery(unittest.TestCase):
    ...
    def test_init_client(self):
        ...
        with patch('hugegraph_llm.operators.hugegraph_op.graph_rag_query.PyHugeClient') as mock_client_class, \
             patch('hugegraph_llm.operators.hugegraph_op.graph_rag_query.isinstance') as mock_isinstance:
    ...
    def test_format_graph_query_result(self):
        ...
        try:
            # Run the method
            v_cache, vertex_degree_list, knowledge_with_degree = self.graph_rag_query._format_graph_query_result(query_paths)
