...
class SAGE(nn.Module):
    def __init__(self, in_feats, n_hidden, n_classes):
        ...
        self.layers.append(dglnn.SAGEConv(in_feats, n_hidden, "mean")) # pylint: disable=E1101
        self.layers.append(dglnn.SAGEConv(n_hidden, n_hidden, "mean")) # pylint: disable=E1101
        self.layers.append(dglnn.SAGEConv(n_hidden, n_classes, "mean")) # pylint: disable=E1101
