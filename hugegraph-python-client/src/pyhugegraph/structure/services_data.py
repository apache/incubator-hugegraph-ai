...
class ServiceCreateParameters:
    ...
    Attributes:
        ...
        - route_type (str): Required when deployment_type is 'K8S'. Accepted values are 'ClusterIP', 'LoadBalancer', 'NodePort'.
        - port (int): Required when deployment_type is 'K8S'. Must be greater than 0. Default is None and invalid for other deployment types.
        - urls (List[str]): Required when deployment_type is 'MANUAL'. Should not be provided for other deployment types.
        - deployment_type (str): The deployment type of the service. 'K8S' indicates service deployment through a Kubernetes cluster,
